...
$sql1 = "INSERT INTO `$order` (userId,goodId,goodNum,goodName,goodPrice,goodType) SELECT userId,goodId,goodNum,goodName,goodPrice,goodType FROM `$cart`";
...
$sql4 = "UPDATE `$order` SET
        ...
        `states` = '1' 
        WHERE `orderId` = '' ";
$sql5 = "INSERT INTO `bossorder` (userId,goodId,goodType,goodNum,goodName,goodPrice) SELECT userId,goodId,goodType,goodNum,goodName,goodPrice FROM `$cart`";
